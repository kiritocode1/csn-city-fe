...
const SeniorOfficer = () => {
  ...
  const onOpenModal2 = (
    ...
    setphoneF(DOMPurify.sanitize(phone));
    setemailF(DOMPurify.sanitize(email));

    setPhoto(DOMPurify.sanitize(photo));
    setmobile(DOMPurify.sanitize(mobile));
  ...
  const fetchrecords = async () => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/get-senior-officer`,
        {
          method: "GET",
        }
      );
  ...
  const deleterecord = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/delete-senior-officer?Id=${id}`,
        {
          method: "DELETE",
          headers: headers,
        }
  ...
  const submithandler = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/add-senior-officer`,
        {
          method: "POST",
          body: formData,
          headers: headers,
  ...
  const updateHandler = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/update-senior-officer?Id=${idF}`,
        {
          method: "PATCH",
          body: formData,
          headers: headers,
          ...
          <div className="flex flex-row">
            ...
            <div className="w-full lg:w-4/5 mt-20 mx-5 bg-white shadow p-5">
              ...
              <div className="mb-52 w-full bg-white">
                <h1 className="font-semibold text-xl mt-10">Senior Officers</h1>
