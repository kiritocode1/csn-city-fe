...
const FormerADG = () => {
  ...
  const onOpenModal2 = (
    ...
    setFrom_dateF(DOMPurify.sanitize(from_date));
    setTo_dateF(DOMPurify.sanitize(to_date));
  ...
  const submithandler = async (e) => {
    ...
    formData.append("from_date", DOMPurify.sanitize(from_date));
    formData.append("to_date", DOMPurify.sanitize(to_date));
    if (file) {
  ...
  const updateHandler = async (e) => {
    ...
    formData.append("from_date", DOMPurify.sanitize(from_dateF));
    formData.append("to_date", DOMPurify.sanitize(to_dateF));
    if (fileF) {
