...
const Zone = () => {
  ...
  const [dcp_name, setdcp_name] = useState("");
  const [dcp_name_in_marathi, setdcpname_in_marathi] = useState("");
  const [dcp_contact, setdcp_contact] = useState("");
  ...
  const [dcp_nameF, setdcp_nameF] = useState("");
  const [dcp_name_in_marathiF, setdcpname_in_marathiF] = useState("");
  const [dcp_contactF, setdcp_contactF] = useState("");
  ...
  const onOpenModal2 = (
    ...
    setdcp_nameF(DOMPurify.sanitize(dcp_name));
    setdcpname_in_marathiF(DOMPurify.sanitize(dcp_name_in_marathi));
    setdcp_contactF(DOMPurify.sanitize(dcp_contact));
  ...
  const deleterecord = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/delete-zone?Id=${id}`,
        {
          method: "DELETE",
          headers: headers,
        }
  ...
  const submithandler = async (e) => {
    ...
    const bodydata = {
      ...
      dcp_name: DOMPurify.sanitize(dcp_name),
      dcp_name_in_marathi: DOMPurify.sanitize(dcp_name_in_marathi),
      dcp_contact: DOMPurify.sanitize(dcp_contact),
    };

    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/add-zone`,
        {
          method: "POST",
  ...
  const updatehandler = async (e) => {
    ...
    const bodydata = {
      name: nameF,
      name_in_marathi: name_in_marathiF,
      sr_no: sr_noF,
      dcp_name: dcp_nameF,
      dcp_name_in_marathi: dcp_name_in_marathiF,
      dcp_contact: dcp_contactF,
    };

    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/update-zone?Id=${idF}`,
        {
          method: "PATCH",
          body: JSON.stringify(bodydata),
          headers: headers,
          ...
          <div className="flex flex-row">
            ...
            <div className="w-full lg:w-4/5 mt-20 mx-5 bg-white shadow p-5">
                ...
                <div className="mt-5">
                  ...
                  <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                    ...
                    <input
                      ...
                      placeholder=""
                      value={dcp_name}
                      onChange={(e) => setdcp_name(e.target.value)}
                    />
                  </div>
                  ...
                  <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                    ...
                    <input
                      ...
                      className="text-base border-b border-b-black px-3 py-2  outline-none focus:border-purple-700"
                      placeholder=""
                      value={dcp_name_in_marathi}
                      onChange={(e) => setdcpname_in_marathi(e.target.value)}
                    />
                  </div>
                  ...
                  <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                    ...
                    <input
                      ...
                      placeholder=""
                      value={dcp_contact}
                      onChange={(e) => setdcp_contact(e.target.value)}
                    />
                  </div>
              ...
              <div className="mb-52 w-full bg-white">
                <h1 className="font-semibold text-xl mt-10">Zone Records</h1>
                ...
                <div className="overflow-x-auto max-w-full">
                  <table className="w-full min-w-[800px] mx-auto mt-5 text-left">
                    <tr className="border flex flex-row justify-between bg-gray-100">
                      ...
                      <th className="p-2 w-5/12 border-r">Zone Name</th>
                      <th className="p-2 w-5/12 border-r">
                        Zone Name in Marathi
                      </th>
                    </tr>
                  ...
                  <div className="pt-10 px-5 w-[500px]">
                    ...
                    <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                      ...
                      <input
                        ...
                        placeholder=""
                        value={dcp_nameF}
                        onChange={(e) => setdcp_nameF(e.target.value)}
                      />
                    </div>
                    ...
                    <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                      ...
                      <input
                        ...
                        className="text-base border-b border-b-black px-3 py-2  outline-none focus:border-purple-700"
                        placeholder=""
                        value={dcp_name_in_marathiF}
                        onChange={(e) => setdcpname_in_marathiF(e.target.value)}
                      />
                    </div>
                    ...
                    <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                      ...
                      <input
                        ...
                        placeholder=""
                        value={dcp_contactF}
                        onChange={(e) => setdcp_contactF(e.target.value)}
                      />
                    </div>
