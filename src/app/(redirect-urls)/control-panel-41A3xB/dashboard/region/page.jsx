...
const Region = () => {
  ...
  const [racp_name, setracp_name] = useState("");
  const [racp_name_in_marathi, setracpname_in_marathi] = useState("");
  const [racp_contact, setracp_contact] = useState("");
  ...
  const [racp_nameF, setracp_nameF] = useState("");
  const [racp_name_in_marathiF, setracpname_in_marathiF] = useState("");
  const [racp_contactF, setracp_contactF] = useState("");
  ...
  const onOpenModal2 = (
    ...
    setracp_nameF(DOMPurify.sanitize(racp_name));
    setracpname_in_marathiF(DOMPurify.sanitize(racp_name_in_marathi));
    setracp_contactF(DOMPurify.sanitize(racp_contact));
  ...
  const deleterecord = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/delete-region?Id=${id}`,
        {
          method: "DELETE",
          headers: headers,
        }
  ...
  const submithandler = async (e) => {
    ...
    const bodydata = {
      ...
      name_in_marathi: DOMPurify.sanitize(name_in_marathi),
      racp_name: DOMPurify.sanitize(racp_name),
      racp_name_in_marathi: DOMPurify.sanitize(racp_name_in_marathi),
      racp_contact: DOMPurify.sanitize(racp_contact),
    };

    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/add-region`,
        {
          method: "POST",
  ...
  const updatehandler = async (e) => {
    ...
    const bodydata = {
      name: DOMPurify.sanitize(nameF),
      name_in_marathi: DOMPurify.sanitize(name_in_marathiF),
      sr_no: DOMPurify.sanitize(sr_noF),
      racp_name: DOMPurify.sanitize(racp_nameF),
      racp_name_in_marathi: DOMPurify.sanitize(racp_name_in_marathiF),
      racp_contact: DOMPurify.sanitize(racp_contactF),
    };

    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/update-region?Id=${idF}`,
        {
          method: "PATCH",
          body: JSON.stringify(bodydata),
          headers: headers,
          ...
          <div className="flex flex-row">
            ...
            <div className="w-full lg:w-4/5 mt-20 mx-5 bg-white shadow p-5">
                ...
                <div className="mt-5">
                  ...
                  <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                    ...
                    <input
                      ...
                      placeholder=""
                      value={racp_name}
                      onChange={(e) => setracp_name(e.target.value)}
                    />
                  </div>
                  ...
                  <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                    ...
                    <input
                      ...
                      className="text-base border-b border-b-black px-3 py-2  outline-none focus:border-purple-700"
                      placeholder=""
                      value={racp_name_in_marathi}
                      onChange={(e) => setracpname_in_marathi(e.target.value)}
                    />
                  </div>
                  ...
                  <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                    ...
                    <input
                      ...
                      placeholder=""
                      value={racp_contact}
                      onChange={(e) => setracp_contact(e.target.value)}
                    />
                  </div>
              ...
              <div className="mb-52 w-full bg-white">
                <h1 className="font-semibold text-xl mt-10">Region Records</h1>
                ...
                <div className="overflow-x-auto max-w-full">
                  <table className="w-full min-w-[800px] mx-auto mt-5 text-left">
                    <tr className="border flex flex-row justify-between bg-gray-100">
                      ...
                      <th className="p-2 w-5/12 border-r">Region Name</th>
                      <th className="p-2 w-5/12 border-r">
                        Region Name in Marathi
                      </th>
                    </tr>
                    ...
                    {records.map((record) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-2 w-5/12 border-r">{name}</td>
                          <td className="p-2 w-5/12 border-r">
                            {name_in_marathi}
                          </td>
                        </tr>
                      );
                  ...
                  <div className="pt-10 px-5 w-[500px]">
                    ...
                    <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                      ...
                      <input
                        ...
                        placeholder=""
                        value={racp_nameF}
                        onChange={(e) => setracp_nameF(e.target.value)}
                      />
                    </div>
                    ...
                    <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                      ...
                      <input
                        ...
                        className="text-base border-b border-b-black px-3 py-2  outline-none focus:border-purple-700"
                        placeholder=""
                        value={racp_name_in_marathiF}
                        onChange={(e) =>
                          setracpname_in_marathiF(e.target.value)
                        }
                      />
                    </div>
                    ...
                    <div className="flex flex-col mx-3 my-1 space-y-1 mb-5">
                      ...
                      <input
                        ...
                        placeholder=""
                        value={racp_contactF}
                        onChange={(e) => setracp_contactF(e.target.value)}
                      />
                    </div>
